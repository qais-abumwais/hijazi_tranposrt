...
public class OfficeLocation extends Base implements PermissionCallBack {
    ...
    private List<Location> locationModelList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //create recycler with hijazi office locations
        createRecyclerViewOfLocations();
    }
